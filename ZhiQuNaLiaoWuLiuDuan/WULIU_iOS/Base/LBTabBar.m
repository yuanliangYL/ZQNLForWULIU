...
//        [plusBtn setBackgroundImage:[UIImage imageNamed:@"jiaoyiwuliu_jiahao"] forState:UIControlStateNormal];
//        [plusBtn setBackgroundImage:[UIImage imageNamed:@"jiaoyiwuliu_jiahao"] forState:UIControlStateHighlighted];
...
//    //调整发布按钮的中线点Y值
//    self.plusBtn.centerY = self.height*0.8 - 2*LBMagin ;
