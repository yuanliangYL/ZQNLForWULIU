...
- (void)backBarButtonItem {
    ...
    // 设置导航颜色可用
    self.navigationController.navigationBar.barTintColor = YLNaviColor;
    self.navigationController.navigationBar.barStyle = UIBarStyleBlack;
   
    self.title = @"城市选择";
    
    self.navigationItem.leftBarButtonItem = [[UIBarButtonItem alloc]initWithImage:[[UIImage imageNamed:@"jiantou_left_white"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal] style:UIBarButtonItemStylePlain target:self action:@selector(backrootTableViewController)];
}
